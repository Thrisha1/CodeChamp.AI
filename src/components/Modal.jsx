...
function Modals({correct,optionSelected}) {
    ...
    return (
        <>
            <Button className="text-black underline text-xl" onClick={() => setOpenModal(true)}>Results</Button>
                ...
                <Modal.Body className="">
                    <div className="space-y-6">
                        ...
                        {/*    if correct.correct is true then type that option selected is connected else option selected is wrong*/}
                            {correct.correct ? `"${optionSelected}" is right answer` : `"${optionSelected}" is wrong answer and here is why : `}
                        </p>
                        <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            ...
                            <a href={correct.resource} target={"_blank"} className={"underline underline-offset-2"}>Additional Resource</a>
                        </p>
                    </div>
                </Modal.Body>
                <Modal.Footer>
